  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved band as @band" do
        ...
        post :create, {:band => { "picture" => "invalid value" }}, valid_session
        assigns(:band).should be_a_new(Band)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested band" do
        ...
        Band.any_instance.should_receive(:update).with({ "picture" => "" })
        put :update, {:id => band.to_param, :band => { "picture" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the band as @band" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Band.any_instance.stub(:save).and_return(false)
        put :update, {:id => band.to_param, :band => { "picture" => "invalid value" }}, valid_session
        assigns(:band).should eq(band)
      end
